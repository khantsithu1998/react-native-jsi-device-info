...
void install(Runtime &jsiRuntime) {
    ...
    auto sum = Function::createFromHostFunction(jsiRuntime,PropNameID::forAscii(jsiRuntime,"sum"),2,[](Runtime &runtime,const Value &thisValue,const Value *arguments,size_t count)->Value{
        int x = arguments[0].getNumber();
        int y = arguments[1].getNumber();
    ...
    jsiRuntime.global().setProperty(jsiRuntime,"sum",move(sum));
